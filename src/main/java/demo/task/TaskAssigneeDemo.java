...
public class TaskAssigneeDemo {
	...
	public void deployAndStart() {
	    ...
	    Deployment deployment = processEngine.getRepositoryService()// 与流程定义和部署对象相关的service
	            ...
	            .name("TaskAssignee示例")// 添加部署的名称
	            .addClasspathResource("diagrams/TaskAssignee.bpmn")// classpath的资源中加载，一次只能加载
	                                                                // 一个文件
	            .addClasspathResource("diagrams/TaskAssignee.png")// classpath的资源中加载，一次只能加载
	                                                            // 一个文件
	            .deploy();// 完成部署
